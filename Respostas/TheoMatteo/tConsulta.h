...
/// @brief Obtem todas as consultas de acordo com o numero de cpf
/// @param cpf 
/// @return vetor contendo todas as consultas
Vector* ObtemConsultasCPF (char* cpf, FILE* file);


/// @brief Aloca memoria para uma consulta dinamicamente sem inicializacao 
/// @return variavel do tipo consulta 
...
/// @brief Verifica se uma paciente eh fumante
/// @param  consulta
/// @return 1 - True, 0 - False
int EhFumante(tConsulta*);

/// @brief Verifica se uma paciente eh diabetico
/// @param  consulta
/// @return 1 - True, 0 - False
int PossuiDiabetesConsulta(tConsulta*);

/// @brief Verifica se um paciente possui alergia
/// @param  consulta
/// @return 1 - True, 0 - False
int PossuiAlergiaConsulta(tConsulta*);

/// @brief Verifica se um paciente ossui historico cancer
/// @param  consulta
/// @return 1 - True, 0 - False
int PossuiHistoricoCancer(tConsulta*);

/// @brief Retorna o tipo de pele de um paciente
/// @param  consulta
/// @return 1 - True, 0 - False
char* TipoPeleConsulta(tConsulta*);
